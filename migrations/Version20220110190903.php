 ...
 */
final class Version20220110190903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` ADD user_id INT DEFAULT NULL, ADD magic_point INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` DROP user_id, DROP magic_point');
    }
}
